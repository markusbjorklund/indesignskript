...
function Putsa() {
  if (app.documents.length < 1) {
    ...
    if (sidnamn.match("VB-") || sidnamn.match("VBA")) {
      ...
      // ändra pluggar för vasabladet
      app.findGrepPreferences.findWhat = "ÖT – bäst på lokala nyheter";
      app.changeGrepPreferences.changeTo = "Vasabladet – bäst på lokala nyheter";
      app.activeDocument.changeGrep();
      ...
      app.changeGrepPreferences.changeTo = "Vasabladet – närproducerat sedan 1856";
      app.activeDocument.changeGrep();
      app.findGrepPreferences.findWhat = "www.ot.fi – ännu mera för dig som prenumerant";
      app.changeGrepPreferences.changeTo = "www.vasabladet.fi – ännu mera för dig som prenumerant";
      app.activeDocument.changeGrep();
